const { decryptSops, sshKeyToAge } = require("../../../dist/index.cjs");
...
describe("node.js CommonJS", async () => {
  ...
  it("should convert RSA SSH key to age", async () => {
  ...
  -----END RSA PRIVATE KEY-----`;
    ...
    match(ageKey, /^AGE-SECRET-KEY-1[A-Z0-9]+$/);
  });

  it("should convert ED25519 SSH key to age", async () => {
  ...
  -----END OPENSSH PRIVATE KEY-----`;
    ...
    equal(actualAgeKey, expectedAgeKey);
  });
});
